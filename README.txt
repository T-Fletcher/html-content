...
a quick look at all the common HTML elements as a user will see them. It is aprticularly useful for creating 
...
- A list of the first instance of every HTML element referenced inside a <code> tag is included. Click a tag to go to it.
  - Some tags will include others, which may not be explicity mentioned, e.g. a <thead> tag inside a <table> tag.
...
The demo page can be used in several way:

1. A standalone HTML file - just open 'html-content.htm' in your browswer of choice.
2. Elements for insertion into another page/CMS - copy everything in the <main> tag and paste it wherever you want to test.
